...
BUCKET_NAME = "wagon-ml-venzke-taxifaremodel"  # ⚠️ replace with your BUCKET NAME
...
def download_model(model_directory="Pipeline", bucket=BUCKET_NAME, rm=True):
    ...
    storage_location = 'models/{}/{}/{}'.format(
        ...
        model_directory,
        'model.joblib')
    #storage_location = 'models/taxifare/Pipeline/'
